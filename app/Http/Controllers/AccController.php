...
class AccController extends Controller
{
    function index()
    {
        ...
        return view('accounting.index', [
            ...
            'kas' =>  Kas::whereDate('created_at', $today)->get(),
            'hutang' => Hutang::whereDate('created_at', $today)->get(),
    ...
    function stoksapi()
    {
        ...
        $heading = 'Accounting';
        $active = 'dashboard';
        $status = Hutang::getStatuses();

        // dd($status);
        return view('accounting.data_sapi.index', [
            'hutang' => Hutang::with(['user'])->get(),
            'piutang' => Piutang::all(),
            'title' => $title,
            'heading' => $heading,
            'active' => $active,
    ...
    function indexKas()
    {
        ...
        $saldorekening = Pembayaran::with(['rekening'])->sum('debit');
    ...
    {
        $data = Kas::where('id', $id)->with(['hutang', 'piutang', 'operasional', 'pembayaran', 'user', 'belipakan', 'salary', 'kasbon'])->first();
        ...
        if ($jurnal_id == 1) {
            ...
            return view('accounting.kas.detail.piutang', [
                ...
                'active' => 'buku',
                'rekening' => Rekening::all(),
                'sapi' => Hutang::where('status', 'Dikandang')->get(),
            ]);
        } elseif ($jurnal_id == 3) {
            return view('accounting.kas.detail.pakan', [
                'data' => $data,
                'title' => 'Data Kas',
                'active' => 'buku',
                'pakan' => pakan::all(),
    ...
    public function indexpakan()
    {
        ...
        return view('accounting.pakan.index', [
            ...
            'heading' => $heading,
            'active' => $active,
            'pakan' => Pakan::with(['belipakan', 'pakaipakan'])->get(),
