...
class AccController extends Controller
{
    ...
    function indexKas()
    {
        ...
        return view('accounting.kas.index', [
            ...
            'suppakans' => User::where('id_role', '4')->get(),
            'pekerja' => User::where('id_role', '7')->get(),
            ...
            'supsapis' => User::where('id_role', '5')->get(),
            'cust' => User::where('id_role', '6')->get(),
    ...
    public function indexpakan()
    {
        ...
        return view('accounting.pakan.index', [
            ...
            'supplier' => User::where('id_role', '4')->get(),
        ]);
    }
