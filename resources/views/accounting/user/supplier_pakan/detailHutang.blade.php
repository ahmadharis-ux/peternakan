@php
    $listDetailPembelian = $kredit->pembelianPakan->detailPembelianPakan;
    $listOperasionalPembelian = $kredit->pembelianPakan->operasionalPembelianPakan;
...
@section('container')
    <section class="section dashboard">
        ...
        <div class="card recent-sales">
            <div class="card-title px-3">List pakan dibeli</div>
            <div class="card-body">
