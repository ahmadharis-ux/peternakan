<div class="modal fade" id="modalCetakFaktur" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="/acc/pakan/{{ $pembelianPakan->id }}/invoice" method="post" enctype="multipart/form-data">
                @csrf
                <input type="hidden" readonly class="form-control" value="{{ $pembelianPakan->kredit->id }}"
                    name="id_kredit">

                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Cetak faktur pembelian pakan</h1>
