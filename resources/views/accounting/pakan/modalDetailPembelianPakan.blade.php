<!-- Modal -->
<div class="modal fade" id="modalCreateDetailPembelianPakan" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="mb-2">
                        ...
                        <input type="hidden" name="id_pembelian_pakan" value="{{ $pembelianPakan->id }}"
                            class="form-control">
                        <select name="id_pakan" id="" class="form-select" required>
                    ...
                    <div class="mb-3">
                        ...
                        @foreach ($ListSatuan as $satuan)
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="id_satuan_pakan"
                                    value="{{ $satuan->id }}" id="flexRadioDefault1">
