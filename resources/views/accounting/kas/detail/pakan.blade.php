...
<section class="section dashboard">
    <div class="card">
        ...
        <div class="card-body">
            <div class="section">
                <button class="btn btn-primary btn-sm mt-3" data-bs-toggle="modal" data-bs-target="#pakan">Beli Pakan</button>
                 <!-- Modal -->
                            ...
                            <div class="modal-body">
                                <div class="row mt-2">
                                    ...
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <input type="hidden" value="{{$data->id}}" class="form-control" name="kas_id" required>
                                    </div>
                                    <div class="col-sm-12 mb-3">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="section my-3 mx-3">
                <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#pembayaran">Bayar</button>
                  <!-- Modal -->
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm justify-content-end">
                           Rp. {{number_format($data->belipakan->sum('harga_total') - $data->pembayaran->sum('kredit'))}}
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        ...
                        <div class="col-sm justify-content-end">
                            @if ($data->pembayaran->sum('kredit') == $data->belipakan->sum('harga_total'))
                            Lunas
                            @elseif($data->pembayaran->sum('kredit') < $data->belipakan->sum('harga_total'))
                            Belum Lunas   
                            @endif
                        </div>
                    </div>
