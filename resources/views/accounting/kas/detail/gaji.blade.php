...
<section class="section dashboard">
        <div class="card">
            <h5 class="text-center mt-2">Penggajian Bulan {{date("F", strtotime($data->created_at))}} Tahun {{date("Y", strtotime($data->created_at))}}</h5>
            ...
            <div class="row">
                <div class="col-sm my-2 mx-2">
                    <div class="card-header" style="border-color: blue">
                        {{-- Gaji --}}
                        <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#bayar">Bayar Gaji</button>
                        <!-- Modal -->
                          ...
                          <div class="modal-content">
                              <form action="/storetrans" method="post" enctype="multipart/form-data">
                                  ...
                                  <div class="modal-header">
                                      <h1 class="modal-title fs-5" id="staticBackdropLabel">Bayar Gaji Pegawai</h1>
                                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                  </div>
                                  <div class="modal-body">
                                    <label for="" class="mb-2">Sisa Gaji Yang Belum dibayar Rp. {{number_format($data->salary->sum('salary') - ($data->pembayaran->sum('kredit')+$data->kasbon->sum('nominal')))}}</label>
                                    <div class="col-sm-12">
                                        <label for="">Nominal</label>
                                        <input type="number" class="form-control" name="kredit">
                                        <input type="hidden" class="form-control" name="kas_id" value="{{$data->id}}">
                ...
                <div class="col-sm my-2 mx-2">
                    <div class="card-header" style="border-color: green">
                        {{-- Kasbon --}}
                        <button type="button" class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#kasbon">Kasih Kasbon</button>
                        <!-- Modal -->
                        <div class="modal fade" id="kasbon" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                          <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
