                    ...
                    <div class="row">
                      <div class="col-sm">
                        <div class="container mb-3">
                            ...
                            <div class="modal-content">
                                <form action="/storekas" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="staticBackdropLabel">Kas {{$hutang->name}}</h1>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                      <div class="col-sm-12">
                                        <label for="">Supplier Sapi</label>
                                        <input type="hidden" name="jurnal_id" value="{{$hutang->id}}" required>
                          ...
                          {{-- Piutang --}}
                          <button type="button" class="btn btn-sm btn-secondary" data-bs-toggle="modal" data-bs-target="#piutang">Piutang</button>
                          <!-- Modal -->
                          ...
                          {{-- pakan --}}
                          <button type="button" class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#pakan">Pakan</button>
                                    ...
                                    <div class="col-sm-12">
                                      ...
                                      <select name="user_id" id="" class="form-select">
                                        @foreach ($suppakan as $pakan)
                                            <option value="{{$pakan->id}}">{{$pakan->name}}</option>
                                        @endforeach
                                      </select>
                                    </div>
                                    <div class="col-sm-12">
                          ...
                          {{-- Gaji --}}
                          <button type="button" class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#gaji">Gaji</button>
                          <div class="modal fade" id="gaji" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" >
                            <div class="modal-dialog modal-dialog-centered">
                              <div class="modal-content">
                                <form action="/storekas" method="post" enctype="multipart/form-data">
                                  @csrf   
                                  ...
                                  <div class="modal-body">
                                    <div class="col-sm-12">
                                      ...
                                      <input type="hidden" name="jurnal_id" value="{{4}}" required>
                                      <input type="hidden" name="author" value="{{auth()->user()->name}}" required>
                                      <select name="user_id" id="" class="form-select">
