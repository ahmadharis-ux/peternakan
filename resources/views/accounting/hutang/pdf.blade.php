            ...
            <div class="card-body">
                ...
                <table>
                    ...
                    <tr>
                      ...
                      <td>Rp. {{number_format(($data->bobot * $data->harga) - $data->pembayaran->sum('debit'))}}</td>
                    </tr>
                    <tr>
                      <td>Status</td>
                      <td>   @if (($data->bobot * $data->harga) == $data->pembayaran->sum('debit') || ($data->bobot * $data->harga) == $data->pembayaran->sum('kredit') )
                        Lunas
                        @else
                            Belum Lunas
                        @endif</td>
                ...
                <table>
                    ...
                    <tr>
                      <th>Telah dibayar</th>
                      <td></td>
                      <td>Rp. {{number_format($data->pembayaran->sum('kredit'))}}</td>
                    </tr>
                    <tr>
                      <th>Sisa Pembayaran </th>
                      <td></td>
                      <td>Rp. {{number_format(($data->bobot * $data->harga) - $data->pembayaran->sum('kredit'))}}</td>
                    </tr>
                    <tr>
                      <th>Status</th>
                      <td></td>
                      <td>   @if (($data->bobot * $data->harga) == $data->pembayaran->sum('kredit') || ($data->bobot * $data->harga) == $data->pembayaran->sum('debit') )
                        Lunas
                        @else
                            Belum Lunas
                        @endif</td>
                ...
                <table>
                    ...
                    <tr>
                      <th>Sisa Pembayaran </th>
                      <td></td>
                      <td>Rp. {{number_format(($data->qty * $data->harga) - $data->pembayaran->sum('kredit'))}}</td>
                    </tr>
                    <tr>
                      <th>Status</th>
                      <td></td>
                      <td>   @if (($data->qty * $data->harga) == $data->pembayaran->sum('kredit') || ($data->qty * $data->harga) == $data->pembayaran->sum('debit') )
                        Lunas
                        @else
                            Belum Lunas
                        @endif</td>
